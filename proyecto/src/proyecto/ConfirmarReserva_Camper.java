...
public class ConfirmarReserva_Camper extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ConfirmarReserva_Camper dialog = new ConfirmarReserva_Camper();
	 ...
	 * Create the dialog.
	 */
	public ConfirmarReserva_Camper() {
