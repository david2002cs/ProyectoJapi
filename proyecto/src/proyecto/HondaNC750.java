...
public class HondaNC750 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HondaNC750 frame = new HondaNC750();
	...
	public HondaNC750() {
		...
		btn_reservar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConfirmarReserva_Scooter reserva = new ConfirmarReserva_Scooter();
		...
		lblNewLabel_1.setIcon(new ImageIcon("HondaNC.jpg"));
