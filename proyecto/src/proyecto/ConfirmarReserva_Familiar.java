...
public class ConfirmarReserva_Familiar extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ConfirmarReserva_Familiar dialog = new ConfirmarReserva_Familiar();
	 ...
	 * Create the dialog.
	 */
	public ConfirmarReserva_Familiar() {
		...
		contentPanel.add(textField_DNI);
		{
			...
			}
			{
				...
				cancelButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						Familiar cancelar = new Familiar();
