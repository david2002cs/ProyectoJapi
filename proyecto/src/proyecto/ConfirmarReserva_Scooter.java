...
public class ConfirmarReserva_Scooter extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ConfirmarReserva_Scooter dialog = new ConfirmarReserva_Scooter();
	 ...
	 * Create the dialog.
	 */
	public ConfirmarReserva_Scooter() {
