...
public class FiatDucato extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FiatDucato frame = new FiatDucato();
	...
	public FiatDucato() {
		...
		txtpnReconocimientoSealesDe.setText("Sensor de parking\r\n\r\nNavegador\r\n\r\nSensor de lluvia\r\n\r\nBluetooth");
		...
		lblNewLabel_1.setIcon(new ImageIcon("FiatDucato.jpg"));
