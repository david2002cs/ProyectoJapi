...
public class Familiar extends JFrame {
	...
	public Familiar() {
		...
		JLabel lblNewLabel = new JLabel("Coches Familiares");
		...
		btn_Peugot.setIcon(new ImageIcon("golf.jpg"));
		...
		btn_C4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				megane.setVisible(true);
				dispose();
			}
		});
		btn_C4.setIcon(new ImageIcon("megan.jpg"));
		btn_C4.setBackground(Color.WHITE);
		btn_C4.setBounds(10, 289, 356, 200);
		contentPane.add(btn_C4);
		
		JLabel coche_C4 = new JLabel("Renault Megane Sport");
		...
		txtpnFechaKilimetros_2.setText("Fecha: 07/2020\r\nKilimetros: 8.809\r\nHíbrid enchufable\r\nauto\r\nProcedencia particular");
		...
		JLabel NewLabel_Precio_1 = new JLabel("21.500 €");
