...
public class Camper extends JFrame {
	...
	public Camper() {
		...
		JLabel lblNewLabel = new JLabel("Camper");
		...
		btn_Peugot.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FiatDucato fiatDucato = new FiatDucato();
				fiatDucato.setVisible(true);
				dispose();
			}
		});
		btn_Peugot.setIcon(new ImageIcon("FiatDucato.jpg"));
		...
		JLabel coche_puegot = new JLabel("Fiat Ducato");
		...
		txtpnFechaKilimetros.setText("Fecha: 07/2018\r\nKilimetros: 154.345\r\nDiésel\r\nManual\r\nLibre mantenimento");
		txtpnFechaKilimetros.setBounds(376, 116, 335, 81);
		contentPane.add(txtpnFechaKilimetros);
		
		JLabel NewLabel_Precio = new JLabel("35.250 €");
		...
		btn_C4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				California.setVisible(true);
				dispose();
			}
		});
		btn_C4.setIcon(new ImageIcon("californiaCamper.jpg"));
