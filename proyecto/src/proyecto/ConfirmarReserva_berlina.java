...
public class ConfirmarReserva_berlina extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ConfirmarReserva_berlina dialog = new ConfirmarReserva_berlina();
	 ...
	 * Create the dialog.
	 */
	public ConfirmarReserva_berlina() {
