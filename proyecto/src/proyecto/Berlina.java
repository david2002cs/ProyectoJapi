...
public class Berlina extends JFrame {
	...
	public Berlina() {
		...
		JLabel lblNewLabel = new JLabel("Berlinas");
		...
		btn_Peugot.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FordKuga fordKuga = new FordKuga();
				fordKuga.setVisible(true);
				dispose();
			}
		});
		btn_Peugot.setIcon(new ImageIcon("fordKuga(1).jpg"));
		...
		JLabel coche_puegot = new JLabel("Ford kuga");
		...
		txtpnFechaKilimetros.setText("Fecha: 07/2017\r\nKilimetros: 140.237\r\nDiésel\r\nManual");
		txtpnFechaKilimetros.setBounds(376, 116, 335, 75);
		contentPane.add(txtpnFechaKilimetros);
		
		JLabel NewLabel_Precio = new JLabel("17.590 €");
		...
		btn_C4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ToyotaRAv toyotaRAv = new ToyotaRAv();
				toyotaRAv.setVisible(true);
				dispose();
			}
		});
		btn_C4.setIcon(new ImageIcon("toyotaRav4(1).jpg"));
